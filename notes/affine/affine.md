...
## Definition of affinely independent points
A collection of points $S = \{P_1, \ldots, P_k\}$ in an affine space is said to be **affinely independent** if the affine subspace generated by $S$ is $k-1$-dimensional.
...
### Remark
This proves that the definition of barycenter is independent of which point we choose for $P_1$, so barycenter is a property of some finite collection of points.
